...
check "Config read" "$(curl -s -o /dev/null -w '%{http_code}' $BACKEND/v3/config 2>/dev/null || echo '500')" "200"check "Disk usage" "$(curl -s -o /dev/null -w '%{http_code}' $BACKEND/v3/disk)" "200"
